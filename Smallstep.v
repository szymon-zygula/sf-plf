...
Proof.
  ...
  - intros.
    ...
    + subst.
      ...
      * eapply step_deterministic in H0.
        apply H0 in H.
        subst.
        assumption.
      * intros contra.
...
Proof.
  ...
  induction H.
  - constructor.
  - apply multistep_congr_1 with (t2 := t2) in IHeval1.
    apply multistep_congr_2 with (v1 := C n1) in IHeval2.
    + eapply multi_trans.
      * apply IHeval1.
      * eapply multi_trans.
        -- eapply IHeval2.
...
Proof.
  ...
  assert (HP: forall t1 t2, exists t3, P t1 t2 --> t3).
  {
    induction t1.
    - induction t2.
      + exists (C ( n + n0)).
      ...
      + destruct IHt2_1.
        ...
        inversion H1; subst.
        * inversion H2; subst.
          -- exists (P (C n) (C (n2 + n0))).
             constructor; constructor.
          -- inversion H6.
          -- exists (P (C n) (P (C n2) t2')).
             constructor.
             ++ constructor.
             ++ constructor.
                ** constructor.
                ** assumption.
        * inversion H6.
        * exists (P (C n) (P t2' t2_2)).
          constructor.
          -- constructor.
          -- constructor.
             assumption.
    - specialize IHt1_1 with (t2 := t1_2).
      destruct IHt1_1.
      intros.
      exists (P x t2).
      constructor.
  ...
  assert (Ha: forall t, exists n, t -->* C n).
  {
    induction t0.
